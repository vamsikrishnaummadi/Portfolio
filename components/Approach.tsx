    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
          ...
          description="We'll collaborate to map out to 
          your website's goals, target audience, and 
          key functionalities. we'll discuss things like 
        ...
        <Card 
         ...
         my lofi playlist and dive into coding. 
         From intial sketches to polished code, I keep you
