...
const Footer = () => {
  return (
    <footer className="w-full pt-20 bg-footer-background mb-[100px] md:mb-5" id="contact">
         <div className='flex flex-col items-center'>
            ...
            <a href="mailto:krishnavamsi9432@gmail.com">
                <MagicButton 
         ...
         <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
            <p className='md:text-base text-sm md:font-normal font-light'>Copyright &copy; 2024 Vamsi Krishna</p>
