...
export const BentoGridItem = ({ 
  ...
  const handleCopy = () => {
       navigator.clipboard.writeText('krishnavamsi9432@gmail.com');
           ...
           {id === 3 && (
              <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                  ...
                  <span className="py-2 px-3 rounded-lg text-center bg-[#10132E]" />
                        {['Reactjs', 'SQL', 'MongoDB'].map((item) => (
                          <span key={item} className="py-2 lg:py-2 lg:px-2 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]">
                             {item}
                          </span>
                        ))}
                  </div> 
